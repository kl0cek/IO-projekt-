...
const SeatBox = props => {
    ...
    return (
        <div onClick={!showPopUp ? userSelect : null} style={{width: '50px', height: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: `${userSelected ? "orange" : "green"}`}}>
            <p>{props.number}</p>
